...
#     summary_msg = f"✅ Form Completed Successfully!\n\nForm: {form['title']}\nVisa Type: {form['visa_type']}\nCompleted: {answers_count}/{total_fields} fields\n\nView full summary: /api/summary/{session_id}\n\nWould you like to fill another form?"
...
#             help_response = f"💡 Let me help you with this field:\n\n{help_text}\n\nOnce you understand, just type your answer and I'll save it!"
...
#         if not is_valid:
#             invalid_response = f"⚠️ {validation_msg}\n\nPlease provide a valid answer.\n\nNeed help? Just type 'help'"
...
#             completion_msg = f"🎉 Congratulations! Form Completed!\n\nYou've successfully filled all {total_fields} fields of:\n{form['title']} ({form['visa_type']})\n\nView Summary: /api/summary/{session_id}\n\nWould you like to fill another visa form?"
...
#         ready_msg = f"✅ Perfect! Let's proceed with:\n\n📄 {form['title']}\n🌍 Visa Type: {form['visa_type']}\n📊 Total Fields: {len(form.get('fields', []))}\n\n✨ May we start filling the form now? Say 'Yes, let's begin'"
...
#         start_msg = f"🎯 Great! Let's begin filling the form.\n\n{question}\n\n💡 Tip: Type 'help' anytime if you need assistance!"
...
#     if user_msg_count == 1:
#         greeting = """👋 Hello! Welcome to our Visa Application Assistant!

# I'm here to help you find and fill the right visa form for your needs. Let's have a quick chat to understand your requirements.

# To get started, which country would you like to visit?"""
...
#         match_msg = f"✨ Perfect! I found the right form for you:\n\n📄 {matched['title']}\n🌍 Visa Type: {matched['visa_type']}\n🗺️ Country: {matched.get('country', 'N/A')}\n📊 Total Fields: {len(matched.get('fields', []))}\n\n✅ May we proceed with filling this form? Say 'Yes, let's begin' when you're ready!"
...
#             message = f"📋 I found {len(forms)} possible forms.\n\n✨ I recommend:\n📄 {recommended['title']}\n🌍 {recommended['visa_type']} visa for {recommended.get('country', 'N/A')}\n\n💡 {explanation}\n\nIs this correct? Say 'Yes' to proceed!"
...
#     message = f"📋 I found {len(forms)} matching forms.\n\n✨ I recommend:\n📄 {recommended['title']}\n🌍 {recommended['visa_type']} for {recommended.get('country', 'N/A')}\n\nThis matches your needs best. Say 'Yes' to proceed!"
